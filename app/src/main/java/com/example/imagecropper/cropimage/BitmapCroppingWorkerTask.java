...
final class BitmapCroppingWorkerTask
  ...
  private final WeakReference<com.example.imagecropper.cropimage.CropImageView> mCropImageViewReference;
  ...
  private final com.example.imagecropper.cropimage.CropImageView.RequestSizeOptions mReqSizeOptions;
  ...
  BitmapCroppingWorkerTask(
      com.example.imagecropper.cropimage.CropImageView cropImageView,
      Bitmap bitmap,
      float[] cropPoints,
      int degreesRotated,
      ...
      com.example.imagecropper.cropimage.CropImageView.RequestSizeOptions options,
      Uri saveUri,
  ...
  protected void onPostExecute(Result result) {
    if (result != null) {
      ...
      if (!isCancelled()) {
        com.example.imagecropper.cropimage.CropImageView cropImageView = mCropImageViewReference.get();
