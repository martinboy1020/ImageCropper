...
public final class CropImage {
  ...
  /** The key used to pass crop image source URI to {@link OriginCropImageActivity}. */
  public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

  /** The key used to pass crop image options to {@link OriginCropImageActivity}. */
  public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

  /** The key used to pass crop image bundle data to {@link OriginCropImageActivity}. */
  public static final String CROP_IMAGE_EXTRA_BUNDLE = "CROP_IMAGE_EXTRA_BUNDLE";

  /** The key used to pass crop image result data back from {@link OriginCropImageActivity}. */
  ...
  /**
   * The request code used to start {@link OriginCropImageActivity} to be used on result to identify the
   * this specific request.
   */
  public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;

  /** The result code used to return error from {@link OriginCropImageActivity}. */
  ...
  public static final class ActivityBuilder {
    ...
    /** Get {@link OriginCropImageActivity} intent to start the activity. */
    public Intent getIntent(@NonNull Context context) {
      return getIntent(context, OriginCropImageActivity.class);
    }
    ...
    /**
     * Start {@link OriginCropImageActivity}.
     *
    ...
    /**
     * the title of the {@link OriginCropImageActivity}.<br>
     * <i>Default: ""</i>
     */
