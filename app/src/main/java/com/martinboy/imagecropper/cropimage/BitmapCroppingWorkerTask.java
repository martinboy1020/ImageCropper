...
final class BitmapCroppingWorkerTask
  ...
  private final WeakReference<com.martinboy.imagecropper.cropimage.CropImageView> mCropImageViewReference;
  ...
  private final com.martinboy.imagecropper.cropimage.CropImageView.RequestSizeOptions mReqSizeOptions;
  ...
  BitmapCroppingWorkerTask(
      com.martinboy.imagecropper.cropimage.CropImageView cropImageView,
      Bitmap bitmap,
      float[] cropPoints,
      int degreesRotated,
      ...
      com.martinboy.imagecropper.cropimage.CropImageView.RequestSizeOptions options,
      Uri saveUri,
  ...
  protected void onPostExecute(Result result) {
    if (result != null) {
      ...
      if (!isCancelled()) {
        com.martinboy.imagecropper.cropimage.CropImageView cropImageView = mCropImageViewReference.get();
